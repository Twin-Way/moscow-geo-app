...
import metroRaw from '../mocks/data/metro_station.geojson?raw';
import busRaw from '../mocks/data/bus_tram_stops.geojson?raw';
import mcdRaw from '../mocks/data/mcd_station.geojson?raw';
import mckRaw from '../mocks/data/mck_station.geojson?raw';
import streetsRaw from '../mocks/data/streets_pedestrian.geojson?raw';
import districtRaw from '../mocks/data/district_layer.geojson?raw';
